...
adminUI::adminUI(QWidget *parent, user *u, usersmodelview *t) : QMainWindow(parent), usersM(t), loginuser(u),
                                                                ui(new Ui::adminUI)
{
    ui->setupUi(this);

    //CARICO I DATI NEI MODELLI
    QFile f("../xml/books.xml");
    QFile f2("../xml/borrow.xml");
    ...
    if (u->getType() == "normal")
    {                              //utente normale allora nascondo alcuni tasti
